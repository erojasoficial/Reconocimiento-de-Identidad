<?php
	...
	$mysqli=new mysqli("localhost","root","","criminales"); //servidor, usuario de base de datos, contraseña del usuario, nombre de base de datos
...
class Conect_MySql {   
     var $obj = array ( "dbname"	=>	"criminales",
                       "dbuser"		=>	"root"		,
                       "dbpwd"		=>	""		,
                       "dbhost"		=>	"localhost"	);
